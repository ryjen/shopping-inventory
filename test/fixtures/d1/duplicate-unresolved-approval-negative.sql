...
VALUES
  ('imp_syn_dup_unresolved', 'env_syn_dup_unresolved_b', '1.0.0', 'import_raw_row', 'line_imp_syn_dup_unresolved', 'synthetic', 'src_imp_syn_dup_unresolved', 1, 'item',
...
VALUES
  ('cand_syn_dup_unresolved', 'imp_syn_dup_unresolved', 'item', 'item_syn_duplicate', 1, 'each', 4.00, 0.99, 'needs_review', '2026-01-18T18:00:03Z');

-- Must fail: fingerprint collision remains unresolved.
...
VALUES
  ('review_event_syn_dup_unresolved', 'purchase_candidate', 'cand_syn_dup_unresolved', 1, 'user', 'reviewer_syn', 'needs_review', 'approved',
