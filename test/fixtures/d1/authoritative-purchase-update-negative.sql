...
VALUES
  ('cand_syn_immutable', 'imp_syn_immutable', 'item', 'item_syn_immutable', 1, 'each', 4.00, 0.98, 'needs_review', '2026-01-15T18:01:00Z');

INSERT INTO review_events
  (event_id, target_kind, target_id, sequence, actor_kind, actor_id, from_state, to_state, occurred_at)
VALUES
  ('rev_syn_immutable', 'purchase_candidate', 'cand_syn_immutable', 1, 'user', 'reviewer_syn', 'needs_review', 'approved', '2026-01-15T18:01:30Z');
...
VALUES
  ('pur_syn_immutable', 'cand_syn_immutable', 'approved', 'item_syn_immutable', 1, 'each', 4.00, '2026-01-15T10:00:00Z', NULL, '2026-01-15T18:02:00Z', 'reviewer_syn', 'user');
