...
INSERT INTO review_events
  (event_id, target_kind, target_id, sequence, actor_kind, actor_id, from_state, to_state, reason_code, occurred_at)
VALUES
  ('rev_syn_rel_primary', 'purchase_candidate', 'cand_syn_rel_primary', 1, 'user', 'reviewer_syn', 'needs_review', 'approved', 'accepted', '2026-01-15T18:01:30Z');
...
VALUES
  ('pur_syn_rel_primary', 'cand_syn_rel_primary', 'approved', 'item_syn_rel', 1, 'each', 4.00, '2026-01-15T10:00:00Z', NULL, '2026-01-15T18:02:00Z', 'reviewer_syn', 'user', 'corr_syn_primary');

INSERT OR IGNORE INTO purchases
  (purchase_id, source_candidate_id, source_review_state, canonical_item_id, quantity, unit, amount, acquired_at, supersedes_id, created_at, actor_id, actor_kind, correlation_id)
VALUES
  ('pur_syn_rel_duplicate', 'cand_syn_rel_primary', 'approved', 'item_syn_rel', 1, 'each', 4.00, '2026-01-15T10:00:00Z', NULL, '2026-01-15T18:02:01Z', 'reviewer_syn', 'user', 'corr_syn_duplicate');
...
INSERT INTO purchase_candidates
  (candidate_id, source_import_id, source_line_type, canonical_item_id, quantity, unit, amount, normalization_confidence, review_state, created_at)
VALUES
  ('cand_syn_rel_correction', 'imp_syn_rel_correction', 'item', 'item_syn_rel', 2, 'each', 8.00, 0.99, 'needs_review', '2026-01-15T18:04:00Z');

INSERT INTO review_events
  (event_id, target_kind, target_id, sequence, actor_kind, actor_id, from_state, to_state, reason_code, occurred_at)
VALUES
  ('rev_syn_rel_correction', 'purchase_candidate', 'cand_syn_rel_correction', 1, 'user', 'reviewer_syn', 'needs_review', 'approved', 'correction_approved', '2026-01-15T18:04:30Z');

INSERT INTO purchases
  (purchase_id, source_candidate_id, source_review_state, canonical_item_id, quantity, unit, amount, acquired_at, supersedes_id, created_at, actor_id, actor_kind, correlation_id)
VALUES
  ('pur_syn_rel_correction', 'cand_syn_rel_correction', 'approved', 'item_syn_rel', 2, 'each', 8.00, '2026-01-15T10:00:00Z', 'pur_syn_rel_primary', '2026-01-15T18:05:00Z', 'reviewer_syn', 'user', 'corr_syn_correction');
...
SELECT CASE
  WHEN (
    ...
    WHERE target_kind = 'purchase'
      AND target_id IN ('pur_syn_rel_primary', 'pur_syn_rel_correction')
      AND action IN ('purchase_promoted', 'purchase_superseded')
  ) = 2 THEN 1
  ELSE json_extract('invalid-json', '$')
END AS attributable_purchase_audit_ok;
