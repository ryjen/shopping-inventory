...
Current-tree remediation is complete. The default branch has been rebuilt from the last safe pre-receipt commit plus the sanitized current tree. Historical object cleanup and external clone/cache limitations remain tracked under issue #10.
